...
var precacheConfig = [
		[
			'/component-driven-development/index.html',
			'0b2e1a7f21857285e453bc3b45658a0f',
		],
		[
			'/component-driven-development/static/js/main.09f18280.js',
			'7b34edb3f19839b09c4ab40d2add2ca0',
		],
	],
	cacheName =
...
self.addEventListener('install', function(e) {
	...
	self.addEventListener('fetch', function(e) {
		if ('GET' === e.request.method) {
			...
			var a = '/component-driven-development/index.html';
			!n &&
				'navigate' === e.request.mode &&
				isPathWhitelisted(['^(?!\\/__).*'], e.request.url) &&
				((t = new URL(a, self.location).toString()),
				(n = urlsToCacheKeys.has(t))),
				n &&
					e.respondWith(
						caches
