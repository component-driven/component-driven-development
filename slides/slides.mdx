...
- Custom HTML element (`p`, `span`, `label`)
...
# Minimal number of styles for most of your use cases
...
## API design: rigidity vs flexibility
...
## API design: custom HTML element
