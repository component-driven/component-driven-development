...
import { Cover, Primary, Secondary, Boom, Appear, Image, ThatGuy, Code } from './theme';
...
> Rudimentary abilities of HTML coupled with an incredibly powerful declarative nature of CSS gives developers a false sense of simplicity when building things for the Web.
