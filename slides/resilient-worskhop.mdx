...
- Design primitives and compose them
- Make impossible states impossible (`variant`)
...
- Pass all HTML props down
- Do not overload valid HTML attributes
- Merge styles and `className`
- Merge event handlers when wrapping
