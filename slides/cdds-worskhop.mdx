...
<Figure
	src={require('./assets/react-styleguidist.svg')}
...
<Image src={require('./assets/dribbble1.png')} size="contain" />

---

<Image src={require('./assets/dribbble2.png')} size="contain" />
...
<Image src={require('./assets/doors.jpg')} />
...
<Image src={require('./assets/too-many-buttons.jpg')} size="contain" />

---

<Image src={require('./assets/too-many-buttons-2.jpg')} size="contain" />

---

<Image src={require('./assets/text.png')} size="contain" />
...
<Image src={require('./assets/dls-foundation.png')} size="contain" />
...
<Figure
	src={require('./assets/ui-inventory-1.png')}
...
<Figure
	src={require('./assets/ui-inventory-2.png')}
	alt="UI inventory process"
/>
...
<Figure
	src={require('./assets/ui-inventory-3.png')}
	alt="UI inventory process"
/>

---

<Figure src={require('./assets/text.png')} alt="Different text styles" />

---

<Code language="javascript">
	{require('raw-loader!./code/themeExample.txt').default}
</Code>
...
<Figure
	src={require('./assets/design-tokens-colors.png')}
...
<Figure
	src={require('./assets/design-tokens-gradients.png')}
...
<Figure
	src={require('./assets/design-tokens-fonts-spacing.png')}
...
<Figure
	src={require('./assets/design-tokens-misc.png')}
	alt="Design tokens"
	caption={
...
<Figure
	src={require('./assets/colorsnapper.png')}
	alt="Colorsnapper"
...
<input type="button">Button</input>`}
		...
		<div>
			<Code language="html">
				{require('raw-loader!./code/dropdownHTML.txt').default}
			</Code>
		</div>
		<span>😩</span>
	</Appear>
...
<Figure
	src={require('./assets/bootstrap-dropdown.png')}
...
<Image src={require('./assets/bootstrap-dropdown.png')} size="contain" />
...
<Code language="jsx">
	{require('raw-loader!./code/dropdownJSX.txt').default}
</Code>
...
<Image src={require('./assets/legos.jpg')} />
...
<Image src={require('./assets/legos-assembled.jpg')} />
...
<Figure
	src={require('./assets/styled-system.png')}
...
<LiveCode code={require('raw-loader!./code/Text.txt').default} />
...
<LiveCode code={require('raw-loader!./code/responsive.txt').default} />
...
<LiveCode code={require('raw-loader!./code/Box-Text.txt').default} />
...
<Figure
	src={require('./assets/spacing-scale.png')}
...
<LiveCode code={require('raw-loader!./code/Box.txt').default} />
...
<LiveCode code={require('raw-loader!./code/Flex.txt').default} />
...
<LiveCode code={require('raw-loader!./code/Grid.txt').default} />
...
<LiveCode code={require('raw-loader!./code/Stack.txt').default} />
...
<LiveCode code={require('raw-loader!./code/Group.txt').default} />
...
<Image src={require('./assets/napkin.jpg')} size="contain" />
