...
<Demo
	src={
		location.hostname !== 'localhost' ? 'about:blank' : 'http://localhost:6061'
	}
/>
...
<Demo
	src={
		location.hostname !== 'localhost'
			? 'cdds.netlify.com/styleguide/#!/Card'
			: 'http://localhost:6060/#!/Card'
	}
/>
...
<Demo
	src={
		location.hostname !== 'localhost'
			? 'cdds.netlify.com/styleguide/#!/SubscriptionForm'
			: 'http://localhost:6060/#!/SubscriptionForm'
	}
/>
