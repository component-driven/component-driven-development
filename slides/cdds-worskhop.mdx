...
{process.env.NODE_ENV !== 'production' && <Demo src="http://localhost:6061" />}
...
{process.env.NODE_ENV === 'production' ? 'cdds.netlify.com/styleguide' : 'http://localhost:6060'}
...
<Demo
	src={
		process.env.NODE_ENV === 'production'
			? 'cdds.netlify.com/styleguide/#!/UI%20Patterns/LoginForm'
			: 'http://localhost:6060/#!/UI%20Patterns/LoginForm'
	}
/>
