...
## 3.2. Add hover and active styles
...
## 3.4. Changing the HTML element used to render a component
...
## 3.5. Creating a basic heading component
...
## 3.6. Creating reusable input field component (bonus)
...
## 3.7. Creating reusable custom select component (bonus)
...
## 3.8. Creating a generic text component (bonus)
