		...
		(n = function() {
										...
										(o = (function maybeUpdateRectForZooming(e, t) {
											if (
												...
												!(function hasBadZoomedRects(e) {
													...
													return (X = Math.abs(r.left - n.left) > 1);
												})(e)
											)
												return t;
					...
					for (
						...
						if (!r[s].hidden) {
							e.options.fixedGutter &&
								...
								r[s].gutterBackground &&
									(r[s].gutterBackground.style.left = i));
							var a = r[s].alignable;
			...
			function normalizeSelection(e, t) {
				...
				for (var n = 1; n < e.length; n++) {
					...
					if (cmp(i.to(), o.from()) >= 0) {
						...
						n <= t && --t, e.splice(--n, 2, new ye(l ? a : s, l ? s : a));
					}
				}
				return new ve(e, t);
			}
			...
			function extendSelection(e, t, r, n, o) {
				null == o && (o = e.cm && (e.cm.display.shift || e.extend)),
					setSelection(
						e,
						new ve([extendRange(e.sel.primary(), t, r, o)], 0),
						n
					);
			}
			...
			function replaceRange(e, t, r, n, o) {
				var i;
				(n || (n = r), cmp(n, r) < 0) && ((r = (i = [n, r])[0]), (n = i[1]));
			...
			function markText(e, t, r, n, o) {
				...
				if (e.cm && !e.cm.curOp)
					return operation(e.cm, markText)(e, t, r, n, o);
				var i = new Ce(e, o),
					s = cmp(t, r);
				if (
			...
			function moveLogically(e, t, r) {
				...
				return null == n
					? null
					: new Pos(t.line, n, r < 0 ? 'after' : 'before');
			}
		...
		(function(e) {
			...
			var l = (function() {
					...
					return (
						(Helper.equals = function(e, t) {
							var r = this,
								n = Object.keys,
								o = typeof e;
							return e && t && 'object' === o && o === typeof t
				...
				c = (function() {
					...
					return (
						(Shared.prototype.delegateCursor = function(e, t, r) {
						...
						(Shared.prototype.applyNext = function(e, t, r) {
							e &&
								e.selection &&
								e.selection.ranges &&
								t &&
							...
							Object.keys(r).some(function(e) {
								...
								Object.keys(r).forEach(function(n) {
									e.options.hasOwnProperty(n) &&
										t.editor.getOption(n) !== r[n] &&
										(t.editor.setOption(n, r[n]), t.mirror.setOption(n, r[n]));
								}),
								this.hydrated ||
						...
						(Controlled.prototype.componentWillUnmount = function() {
							a ||
								(this.props.editorWillUnmount &&
									this.props.editorWillUnmount(i));
						}),
			...
			var d = (function(e) {
				...
				return (
						...
						if (
							(Object.keys(r).some(function(e) {
								...
								Object.keys(r).forEach(function(n) {
									e.options.hasOwnProperty(n) &&
										t.editor.getOption(n) !== r[n] &&
										t.editor.setOption(n, r[n]);
								}),
							!this.hydrated)
						) {
							var n = this.editor.lastLine(),
								o = this.editor.getLine(this.editor.lastLine()).length;
							this.editor.replaceRange(
								e.value || '',
								{ line: 0, ch: 0 },
								{ line: n, ch: o }
					...
					(UnControlled.prototype.shouldComponentUpdate = function(e, t) {
						var r = !0;
						return a && (r = !1), this.detached && (r = !1), r;
					}),
